	...
	<div id="login">
		...
		<div id="login-in" v-if="!hide">
			...
			<ul>
				...
				<li class="verify"><input type="text" name="authcode" placeholder="请输入验证码"><input type="button" class="authCode" v-on:click="verifyUse()" data-value="" value="发送验证码"></li>
				<li class="verify showPass"><input type="password" class="showWord" placeholder="请输入密码"><span class="passWord" v-on:click="togglePassWord('.hideWord','.hidePass')">显示密码</span></li>
				<li class="verify hidePass"><input type="text" class="hideWord" name="password" placeholder="请输入密码"><span class="passWord" v-on:click="togglePassWord('.showWord','.showPass')">隐藏密码</span>
				</li>
...
<script>
	var _czc = _czc || [];
    _czc.push(["_trackEvent", "浏览", "无状态用户"]);
